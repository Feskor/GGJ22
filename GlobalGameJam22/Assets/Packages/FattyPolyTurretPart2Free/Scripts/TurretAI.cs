...
public class TurretAI : MonoBehaviour {
    ...
    GameObject SwapBullet(GameObject bullet)
    {
        MeshRenderer parent = GetComponentInChildren<MeshRenderer>();
        MeshRenderer bulletRen = bullet.GetComponentInChildren<MeshRenderer>();

        bulletRen.material = parent.material;
        bulletRen.material.color = parent.material.color;
